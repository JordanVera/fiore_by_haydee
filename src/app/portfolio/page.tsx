      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="mx-auto mb-14 max-w-2xl text-center">
          <p className="leading-relaxed text-foreground/60">
            {PORTFOLIO_PROJECTS.length} collections designed by{' '}
        ...
        <div className="mt-16 text-center">
          <Link
            href="/contact"
            className="inline-flex bg-[#f59a88] px-8 py-3.5 text-xs font-medium tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[#f8b2a6]"
          >
            Start Your Project
          </Link>
        </div>
