  ...
  return (
    <section className="relative overflow-hidden px-6 py-24 lg:px-8">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          From your first message to delivery day, we handle every floral detail
        ...
        >
          <Link
            href="/contact"
            className="bg-[#f59a88] px-8 py-3.5 text-xs tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[#f8b2a6]"
          >
            Get in Touch
          </Link>
          {COMPANY.phone ? (
